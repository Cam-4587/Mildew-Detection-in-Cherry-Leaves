...
def page_project_hypothesis_body():
    ...
    st.success(
        f"* We suspect cherry leaves with powdery mildew will clearly show white mildew powder \n" 
        f"that can differentiate them from a healthy leaf.\n"
        f"* An image montage shows that an infected cherry leaf has clear spots and patches of white mildew powder "

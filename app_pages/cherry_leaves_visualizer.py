...
def cherry_leaves_visualizer_body():
    st.write("### Cherry leaves visualizer")
    st.info(
        f"* The client is interested in having a study that visually "
        f"differentiates a mildew containing cherry leaf from a healthy cherry leaf.")
    ...
    if st.checkbox("Difference between average and variability image"):
      ...
      st.image(avg_powdery_mildew, caption='Healthy cherry leaf - Average and Variability')
      st.image(avg_healthy, caption='Powdery Mildew Cherry leaf - Average and Variability')
      st.write("---")
